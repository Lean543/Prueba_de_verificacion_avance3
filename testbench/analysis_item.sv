...
//   usando mem_we/mem_re/branch_taken para saber qué comparaciones aplican
//   en cada caso (ver detalle campo por campo más abajo).
//=============================================================================
class analysis_item extends uvm_sequence_item;
    ...
    function string convert2string();
        return $sformatf(
            "op=%-6s pc=%08h instr=%08h | rd=%0d rs1=%0d rs2=%0d imm=%08h | result=%08h next_pc=%08h | mem_we=%0b mem_re=%0b addr=%08h wdata=%08h size=%0d | branch_taken=%0b",
            executed_op, pc, instruction, expected_rd, rs1_val, rs2_val, imm_val,
